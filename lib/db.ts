...
function createMockDb() {
  const products = [
    ...
    { id: 3, name: 'Assorted Chocolates Gift Box', category: 'chocolates', price: 499, original_price: 599, weight: '200g', description: 'Handcrafted with carefully selected nuts.', badge: 'popular', image: 'Chocolates.jpeg', active: 1, stock: 50 },
    { id: 4, name: 'Rainbow Multi-flavour Lollipops', category: 'lollipops', price: 199, original_price: 229, weight: '250g', description: 'Premium all-natural fruit burst!', badge: 'popular', image: 'Rainbow_Multi-Flavoured_Lolipop.jpeg', active: 1, stock: 100 },
  ];
