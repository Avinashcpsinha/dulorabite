...
function createMockDb() {
  const products = [
    ...
    { id: 4, name: 'Rainbow Multi-flavour Lollipops', category: 'lollipops', price: 199, original_price: 229, weight: '250g', description: 'Premium all-natural fruit burst pops! 100% vegetarian.', badge: 'popular', image: 'Rainbow_Multi-Flavoured_Lolipop.jpeg', active: 1, stock: 100 },
